...
@section('content')
<h2>Upload Excel customers to tenant</h2>

<div class="mt-3">
    <form id="upload-form" action="{{route('moderator.uploads.customers.tenant')}}" onsubmit="confirm_submit(event,this.id)" method="post" class="card w-50 px-5 py-5" enctype="multipart/form-data">
        @csrf
        <!-- @if($errors->any())
