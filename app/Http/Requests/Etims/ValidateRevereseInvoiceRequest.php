...
class ValidateRevereseInvoiceRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            // 'customer_kra_pin'=> 'nullable|string|min:10|max:10',
            'supplier_kra_pin'=> 'required|string|min:10|max:10',
