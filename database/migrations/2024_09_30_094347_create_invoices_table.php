...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('invoices', function (Blueprint $table) {
            ...
            $table->double('taxable_amount_C1')->required();
            $table->double('taxable_amount_C2')->required();
            $table->double('taxable_amount_C3')->required();
            $table->double('taxable_amount_D')->required();
            $table->double('taxable_amount_E')->required();
            $table->double('taxable_amount_Rvat')->required();
            $table->double('taxable_amount_Tot')->required();
            $table->double('tax_rate_A')->required();
            $table->double('tax_rate_B')->required();
            $table->double('tax_rate_C1')->required();
            $table->double('tax_rate_C2')->required();
            $table->double('tax_rate_C3')->required();
            $table->double('tax_rate_D')->required();
            $table->double('tax_rate_E')->required();
            $table->double('tax_rate_Rvat')->required();
            $table->double('tax_rate_Tot')->required();
            $table->double('tax_amount_A')->required();
            $table->double('tax_amount_B')->required();
            $table->double('tax_amount_C1')->required();
            $table->double('tax_amount_C2')->required();
            $table->double('tax_amount_C3')->required();
            $table->double('tax_amount_D')->required();
            $table->double('tax_amount_E')->required();
            $table->double('tax_amount_Rvat')->required();
            $table->double('tax_amount_Tot')->required();
